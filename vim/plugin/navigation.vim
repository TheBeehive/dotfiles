...
" QuickFix List items
nnoremap ]q     <Cmd>exec v:count1 . 'cnext'<CR>zv
nnoremap [q     <Cmd>exec v:count1 . 'cprev'<CR>zv
...
" Location List items
nnoremap ]l     <Cmd>exec v:count1 . 'lnext'<CR>zv
nnoremap [l     <Cmd>exec v:count1 . 'lprev'<CR>zv
